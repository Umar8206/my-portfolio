const reviews = {
    ...
    list: [
        ...
        },
        {
            clinet: 'Tom',
            via: 'Fiverr',
            reivew: 'Umar is a great product leader and developer. He helped me accelerate my development by collaborating with many engineers and helped me build my app. I look forward to working with Umar again',
        },
        {
            clinet: 'Ahmed',
            via: 'Fiverr',
        ...
        },
        {
            clinet: 'Adrian',
            via: 'Fiverr',
            reivew: 'Another top shelf delivery from Umar. Happy again, as expected.',
        },
        {
            clinet: 'Adrian',
            via: 'Fiverr',
